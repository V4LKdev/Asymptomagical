...
#include "EsotericUserTypes.generated.h"
...
UENUM(BlueprintType)
enum class EEsotericUserInitializationState : uint8
{
...
UENUM(BlueprintType)
enum class EEsotericUserAvailability : uint8
{
...
UENUM(BlueprintType)
enum class EEsotericUserPrivilegeResult : uint8
{
...
enum class EEsotericUserAsyncTaskState : uint8
{
...
struct FOnlineResultInformation
{
	...
	UPROPERTY(BlueprintReadOnly, Category="UserTypes")
	 ...
	 */
	void ESOTERICUSER_API FromOnlineError(const FOnlineErrorType& InOnlineError);
};
